 ...
 * is prohibited.
 */
public final class ArmorStandBaseCommand extends PlayerCommand<Creative,GameplayManager> {
	
	public ArmorStandBaseCommand(GameplayManager manager){
		super(manager, Rank.MEMBER, "base", "baseplate");
	}
