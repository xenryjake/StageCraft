 ...
 * is prohibited.
 */
public final class ArmorStandSmallCommand extends PlayerCommand<Creative,GameplayManager> {
	
	public ArmorStandSmallCommand(GameplayManager manager){
		super(manager, Rank.MEMBER, "small", "mini");
	}
