 ...
 * is prohibited.
 */
public final class PvPHandler extends Handler<Creative,GameplayManager> {
	...
	public boolean isPvPEnabled(Profile profile){
		...
		return profile.getSetting(Setting.CREATIVE_PVP_ENABLED);
	}
	...
	public boolean isPvPEnabled(Player player){
		...
		if(profile == null){
			return Setting.CREATIVE_PVP_ENABLED.getDefaultValue();
		}
		return isPvPEnabled(profile);
	}
	
	public void setPvPEnabled(Profile profile, boolean enabled){
		profile.setSetting(Setting.CREATIVE_PVP_ENABLED, enabled);
	}
