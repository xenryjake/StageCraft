 ...
 * is prohibited.
 */
public class HeadTagMenu extends Menu<Creative,HeadsManager> {
	
	private final String tag;
	
	public HeadTagMenu(HeadsManager manager, String tag, String uuid){
	...
	protected void tick(Player player, MenuContents contents) {
		...
		contents.fillBorders(getBackgroundItem());
		{
			...
			ItemMeta im = is.getItemMeta();
			im.setDisplayName("§a« View Tags");
			is.setItemMeta(im);
			contents.set(5, 3, Button.runCommandButton(is, "head tags"));
		}
