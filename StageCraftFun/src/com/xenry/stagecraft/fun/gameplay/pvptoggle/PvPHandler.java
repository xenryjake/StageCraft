package com.xenry.stagecraft.fun.gameplay.pvptoggle;
...
import static com.xenry.stagecraft.fun.gameplay.pvptoggle.PvPLock.*;
 ...
 * is prohibited.
 */
public final class PvPHandler extends Handler<Fun,GameplayManager> {
	...
	public boolean isPvPEnabled(Profile profile){
		...
		return profile.getSetting(Setting.FUN_PVP_ENABLED);
	}
	...
	public boolean isPvPEnabled(Player player){
		...
		if(profile == null){
			return Setting.FUN_PVP_ENABLED.getDefaultValue();
		}
		return isPvPEnabled(profile);
	}
	
	public void setPvPEnabled(Profile profile, boolean enabled){
		profile.setSetting(Setting.FUN_PVP_ENABLED, enabled);
	}
