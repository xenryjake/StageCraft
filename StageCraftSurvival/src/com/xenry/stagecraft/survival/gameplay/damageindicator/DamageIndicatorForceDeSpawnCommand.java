	...
	protected void serverPerform(CommandSender sender, String[] args, String label) {
		...
		for(World world : worlds){
			for(Entity entity : world.getEntities()){
				if(!manager.getDamageIndicatorHandler().isDamageIndicatorUnregistered(entity)){
					continue;
				}
				entity.remove();
				i++;
		...
		sender.sendMessage(M.msg + "Forcefully despawned " + M.elm + i + M.msg + " damage indicators in " + M.elm
