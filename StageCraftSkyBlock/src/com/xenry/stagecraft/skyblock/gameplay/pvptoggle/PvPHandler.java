...
import static com.xenry.stagecraft.skyblock.gameplay.pvptoggle.PvPLock.*;
 ...
 * is prohibited.
 */
public final class PvPHandler extends Handler<SkyBlock,GameplayManager> {
	...
	public boolean isPvPEnabled(Profile profile){
		...
		return profile.getSetting(Setting.SKYBLOCK_PVP_ENABLED);
	}
	...
	public boolean isPvPEnabled(Player player){
		...
		if(profile == null){
			return Setting.SKYBLOCK_PVP_ENABLED.getDefaultValue();
		}
		return isPvPEnabled(profile);
	}
	
	public void setPvPEnabled(Profile profile, boolean enabled){
		profile.setSetting(Setting.SKYBLOCK_PVP_ENABLED, enabled);
	}
