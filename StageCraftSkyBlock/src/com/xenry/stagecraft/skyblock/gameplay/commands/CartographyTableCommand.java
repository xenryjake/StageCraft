 ...
 * is prohibited.
 */
public final class CartographyTableCommand extends PlayerCommand<SkyBlock,GameplayManager> {
	
	public CartographyTableCommand(GameplayManager manager){
		super(manager, Rank.HEAD_MOD, "cartographytable", "carttable", "cartography", "cart");
	}
