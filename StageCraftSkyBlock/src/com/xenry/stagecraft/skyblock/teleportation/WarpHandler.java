 ...
 * is prohibited.
 */
public final class WarpHandler extends Handler<SkyBlock,TeleportationManager> {
	...
	public WarpHandler(TeleportationManager manager){
		super(manager);
		collection = manager.plugin.getCore().getMongoManager().getCoreCollection("skyblockWarps");
