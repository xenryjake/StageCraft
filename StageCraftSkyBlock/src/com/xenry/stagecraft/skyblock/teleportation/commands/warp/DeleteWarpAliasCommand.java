 ...
 * is prohibited.
 */
public final class DeleteWarpAliasCommand extends Command<SkyBlock,TeleportationManager> {
	
	public DeleteWarpAliasCommand(TeleportationManager manager){
		super(manager, Rank.ADMIN, "deletewarpalias", "removewarpalias", "delwarpalias");
	}
