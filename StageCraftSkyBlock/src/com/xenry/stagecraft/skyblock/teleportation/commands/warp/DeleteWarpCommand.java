 ...
 * is prohibited.
 */
public final class DeleteWarpCommand extends Command<SkyBlock,TeleportationManager> {
	
	public DeleteWarpCommand(TeleportationManager manager){
		super(manager, Rank.ADMIN, "deletewarp", "removewarp", "delwarp", "warpdelete", "warpremove", "warpdel");
	}
