 ...
 * is prohibited.
 */
public final class IslandTestCommand extends Command<SkyBlock,IslandManager> {
	
	public IslandTestCommand(IslandManager manager){
		super(manager, Rank.ADMIN, "islandtest", "islandstest", "ist");
	}
