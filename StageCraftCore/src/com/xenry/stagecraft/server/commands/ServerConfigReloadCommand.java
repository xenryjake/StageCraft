...
public class ServerConfigReloadCommand extends Command<Core,ServerManager> {
	...
	protected void serverPerform(CommandSender sender, String[] args, String label) {
		manager.plugin.reloadConfiguration();
		sender.sendMessage(M.msg + "Reloaded server configuration.");
		sender.sendMessage(M.DGRAY + M.ITALIC + "Note: server-name can only be updated via server restart.");
	}
